...
# WulffShape_ZB is copied from the WulffShape with a little modification in its _get_all_miller_e(self) method
# for giving correct Wulff analysis of zinc blende structure
class WulffShape_ZB:
    """
    Generate Wulff Shape from list of miller index and surface energies,
    with given conventional unit cell.
    ...
    ################################# Modified _get_all_miller_e(self) ###############################
    def _get_all_miller_e(self):
        """From self: get miller_list(unique_miller), e_surf_list and symmetry operations(symm_ops)
        according to lattice apply symm_ops to get all the miller index, then get normal, get
        all the facets functions for Wulff shape calculation: |normal| = 1, e_surf is plane's
...
# WulffShape_WZ is copied from the WulffShape with a little modification in its _get_all_miller_e(self) method
# for giving correct Wulff analysis of wurtzite structure
class WulffShape_WZ:
    """
    Generate Wulff Shape from list of miller index and surface energies,
    with given conventional unit cell.
